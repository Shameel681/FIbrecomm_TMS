...
<div class="max-w-4xl mx-auto space-y-8" data-aos="fade-up">
    ...
    <div class="flex items-center gap-6 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm border-l-4 border-l-brand-red">
        ...
        <div>
            <h2 class="text-2xl font-black text-brand-navy uppercase tracking-tighter">HR Profile</h2>
            ...
            <div class="mt-2 flex gap-2">
                ...
                <span class="px-3 py-1 bg-gray-100 text-gray-500 text-[9px] font-black uppercase rounded-full">HR Officer</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('hr.profile.update') }}" method="POST" class="p-8 space-y-5">
                @csrf
                @method('PUT')
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('hr.profile.password') }}" method="POST" class="p-8 space-y-5">
                @csrf
                @method('PUT')

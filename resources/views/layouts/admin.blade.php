...
<head>
    ...
    <title>Admin Portal - Fibrecomm Network</title>
    ...
    <style>
        ...
        .sidebar-link::before {
            ...
            width: 100%;
            height: 100%;
            background: rgba(225, 29, 72, 0.1); /* Subtle Red for Admin */
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <div class="p-8 border-b border-white/5">
        <div class="flex flex-col">
            <span class="text-brand-red font-black text-xl tracking-tighter uppercase">Admin Core</span>
            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Root Authority</span>
        </div>
    </div>
    ...
    <nav class="flex-grow p-4 space-y-2 mt-4">
        ...
        <a href="{{ route('admin.users.index') }}" 
           class="sidebar-link {{ Request::is('admin/users') || Request::is('admin/dashboard') ? 'active-link' : '' }} group flex items-center px-4 py-3.5 rounded transition-all text-[11px] font-black uppercase tracking-widest relative">
        ...
        <div class="flex-grow ml-64 flex flex-col">
            ...
            <header class="flex items-center justify-between px-10 py-6 bg-white border-b border-gray-100">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-xl font-black text-brand-navy tracking-tighter uppercase">
                            Admin <span class="text-brand-red">Console</span>
                        </h1>
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right">
                        <p class="text-[10px] font-black text-brand-red uppercase tracking-widest">System Authority</p>
                ...
                <div class="flex items-center px-10">
                    <div class="flex items-center uppercase text-[11px] tracking-[0.2em] font-black">
                        <div class="nav-link relative py-5 px-6 bg-white/5 border-r border-white/5">
                            <span class="text-brand-red">Root:</span> @yield('header_title', 'System Dashboard')
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <footer class="bg-white border-t py-8 px-10 text-center">
                <p class="text-[10px] text-gray-400 uppercase tracking-[0.4em] font-black">
                    &copy; {{ date('Y') }} Fibrecomm Network (M) Sdn Bhd | Admin Control Unit
                </p>
            </footer>
        </div>
    </div>
    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            ...
            const icon = type === 'success' 
                ? '<svg class="w-5 h-5 text-brand-red" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>'
            ...
            toast.innerHTML = `
                ...
                <div class="flex flex-col">
                    <p class="text-[10px] font-black uppercase tracking-widest">${type === 'success' ? 'Admin Success' : 'Admin Alert'}</p>
